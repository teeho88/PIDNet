...
class MyData(BaseDataset):
    def __init__(self, 
        ...
        super(MyData, self).__init__(ignore_label, base_size,
    ...
    def __getitem__(self, index):
        ...
        name = item["name"]
        image = Image.open(os.path.join(self.root,'Dataset_Lane_Segmentation',item["img"])).convert('RGB')
        image = np.array(image)
        size = image.shape

        color_map = Image.open(os.path.join(self.root,'Dataset_Lane_Segmentation',item["label"])).convert('RGB')
